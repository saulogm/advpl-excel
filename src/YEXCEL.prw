...
@param cSenha, characters, Senha do arquivo
@return characters, cArquivo local do arquivo gerado
@type method
/*/
Method Save(cLocal,cSenha) Class YExcel
	...
	For nCont:=1 to Len(::aDraw)
		...
		Endif
	Next
	If !File("\tmpxls\"+::cTmpFile+"\"+::cNomeFile+"\xl\theme\theme1.xml",,.F.)
...
Static Function PlainH_1()
	...
	cRet += '		<a:clrScheme name="Escritorio">' + CHR(13)+CHR(10)
...
Static Function PlainH_2()
	...
	cRet += '		<a:fontScheme name="Escritorio">' + CHR(13)+CHR(10)
...
Static Function PlainH_4()
	...
	cRet += '		<a:fmtScheme name="Escritorio">' + CHR(13)+CHR(10)
